...
__all__ = ["AuthorizationService", "ROLE_PERMISSIONS"]

# Authoritative Role-to-Permission mapping
# Exactly matches the locked SIMS v2.2 privilege matrix
...
class AuthorizationService:
    ...
    @classmethod
    def has_permission(cls, role: Optional[str], permission: Permission) -> bool:
    ...
    @classmethod
    def check_permission(cls, role: Optional[str], permission: Permission) -> None:
        """
    ...
    @classmethod
    def enforce(cls, permission: Permission, actor_role: Optional[str] = None) -> None:
        """
